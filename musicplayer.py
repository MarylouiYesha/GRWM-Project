...
labelbg=PhotoImage(file="labelbg (3).png")
...
song_frame = Label(root, image=labelbg, width=700, height=450)
...
listbox_frame = LabelFrame(root, text='Playlist', font='Courier')
listbox_frame.place(x=650, y=0, height=1000, width=300)

current_song = StringVar(root, value='<Not selected>')

song_status = StringVar(root, value='<Not Available>')

playlist = Listbox(listbox_frame, font=('Courier', 11), selectbackground='Gold', width=1000, height=300)
